              ...
              <Typography variant="h6" color="text.secondary">
               ...
               {hotels.map((hotel) => (
                     ...
                     <CardActions sx={{ p: 2, pt: 0 }}>
                       <Link to={`/detalles-hoteles/${hotel.id}`} style={{ textDecoration: "none", width: "100%" }}>
                         <Button 
                           size="small" 
                           variant="contained"
                           fullWidth
                    ...
                    <Card sx={{ 
                      ...
                      overflow: "hidden"
                       ...
                       <Box sx={{ 
                         ...
                         <Typography variant="body2" color="text.secondary">
                           Estado: {room.estado || "N/A"}
                         </Typography>
                         <Typography variant="subtitle1" color="primary" sx={{ fontWeight: 600 }}>
                           ${room.preciodia || "N/A"}/día
                         </Typography>
                       </Box>
                     </CardContent>
                     <CardActions sx={{ p: 2, pt: 0 }}>
                       <Link to={`/detalles-habitacion/${room.id}`} style={{ textDecoration: "none", width: "100%" }}>
                         <Button 
                           size="small" 
                           variant="contained"
                           fullWidth
